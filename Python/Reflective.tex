...
The syntax to use metaclasses has been modified from Python 2 to Python 3 \cite{mikewatkins_metaclasses}. The syntax of the metaclass' creation is still the same:
\lstinputlisting[language=Python]{code/metaclass.py}

Here is how we use a metaclass in Python 2:
\lstinputlisting[language=Python]{code/class_python2.py}

Here is how we use a metaclass in Python 3:
